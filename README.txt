...
In total, the CPIH database contains 12 sub-databases according to QP and CU size, on account that 4QPs are applied and CUs with 3 different sizes (64¡Á64, 32¡Á32 and 16¡Á16) are allowed to be split.

All data are available at https://__________________
